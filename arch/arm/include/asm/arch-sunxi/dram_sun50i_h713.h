/*
 * H713 dram controller register and constant defines
 *
...
#ifndef _SUNXI_DRAM_SUN50I_H713_H
#define _SUNXI_DRAM_SUN50I_H713_H
...
struct dram_para {
	...
	/*
	 * These fields are not direct names in the captured H713 BT0/FEX
	 * parameter window. Keep them separate while this driver still uses
	 * inherited scaffold writes that need drive/ODT inputs.
	 */
	u32 dx_odt;
	u32 dx_dri;
	u32 ca_dri;
...
#endif /* _SUNXI_DRAM_SUN50I_H713_H */
